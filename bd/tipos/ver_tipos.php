			...
			<div class="wrapper2">
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-12">
							<div class="col-md-8">
								<h2 class="pull-left"><b>Tipos de Bienes</b></h2>
							</div>
							<div class="col-md-4">
								<br>
								<a href="crear_tipos.php" class="btn btn-success pull-right">Agregar nuevo tipo</a>
							</div>
							<?php
							// Include config file
								...
								if(mysqli_num_rows($result) > 0){
									echo "<table class='table table-bordered table-striped'>";
										...
										while($row = mysqli_fetch_array($result)){
											echo "<tr>";
												echo "<td width='4%'>" . $row['ID_Tipo'] . "</td>";
												echo "<td>" . $row['Nom_Tipo'] . "</td>";
												echo "<td width='8%'>";
													echo "<a href='cambiar_tipos.php?ID_Tipo=". $row['ID_Tipo'] ."' title='Actualizar' data-toggle='tooltip'><i class='fas fa-pencil-alt' style='margin-left: 10px; margin-right: 10px'></i></a>";
													echo "<a href='eliminar_tipos.php?ID_Tipo=". $row['ID_Tipo'] ."' title='Eliminar' data-toggle='tooltip'><i class='fas fa-trash-alt' style='margin-left: 10px; margin-right: 10px'></i></a>";
												echo "</td>";
											echo "</tr>";
										}
										echo "</tbody>";                            
