			...
			<div class="wrapper2">
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-12">
							<div class="col-md-8">
								<h2 class="pull-left"><b>Localidades</b></h2>
							</div>
							<div class="col-md-4">
								<br>
								<a href="crear_localidades.php" class="btn btn-success pull-right">Agregar nueva localidad</a>
							</div>
							<?php
							// Include config file
							...
							$sql = "SELECT localidad.ID_Loc, localidad.Nom_Loc, ciudad.Nom_Ciu, estado.Nom_Est FROM localidad inner join ciudad on localidad.ID_Ciu_Loc = ciudad.ID_Ciu inner join estado on ciudad.ID_Est_Ciu = estado.ID_Est group by (ID_Loc);";
								...
								if(mysqli_num_rows($result) > 0){
									echo "<table class='table table-bordered table-striped'>";
										echo "<thead>";
											echo "<tr>";
												echo "<th>#</th>";
												echo "<th>Nombre de la localidad</th>";
										...
										while($row = mysqli_fetch_array($result)){
											echo "<tr>";
												echo "<td>" . $row['ID_Loc'] . "</td>";
												echo "<td>" . $row['Nom_Loc'] . "</td>";
												echo "<td>" . $row['Nom_Ciu'] . "</td>";
												echo "<td>" . $row['Nom_Est'] . "</td>";
												echo "<td width='8%'>";
													echo "<a href='cambiar_localidades.php?ID_Loc=". $row['ID_Loc'] ."' title='Actualizar' data-toggle='tooltip'><i class='fas fa-pencil-alt' style='margin-left: 10px; margin-right: 10px'></i></a>";
													echo "<a href='eliminar_localidades.php?ID_Loc=". $row['ID_Loc'] ."' title='Eliminar' data-toggle='tooltip'><i class='fas fa-trash-alt' style='margin-left: 10px; margin-right: 10px'></i></a>";
												echo "</td>";
											echo "</tr>";
										}
										echo "</tbody>";                            
