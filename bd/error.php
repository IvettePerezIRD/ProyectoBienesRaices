...
<head>
    ...
    <title>LEGACY 9 | ALTO AHÍ VAQUERO</title>
    <!-- InstanceEndEditable -->
				...
				<div class="row">
					<div class="col-md-12">
						<div class="page-header">
							<h1>:o Acción Invalidad</h1>
						</div>
						<div class="alert alert-danger fade in">
							<p>Lo sentimos, ha ejecutado una acción invalida. Por favor <a href="../indexpa.php" class="alert-link">Regrese</a> y trate de nuevo uwu.</p>
						</div>
					</div>
				</div>        
			</div>
