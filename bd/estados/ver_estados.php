			...
			<div class="wrapper2">
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-12">
							<div class="col-md-8">
								<h2 class="pull-left"><b>Estados</b></h2>
							</div>
							<div class="col-md-4">
								<br>
								<a href="crear_estados.php" class="btn btn-success pull-right">Agregar nuevo estado</a>
							</div>
							<?php
							// Include config file
									...
									echo "<table class='table table-bordered table-striped'>";
										...
										while($row = mysqli_fetch_array($result)){
											echo "<tr>";
												...
												echo "<td width='8%'>";
													echo "<a href='cambiar_estados.php?ID_Est=". $row['ID_Est'] ."' title='Actualizar' data-toggle='tooltip'><i class='fas fa-pencil-alt' style='margin-left: 10px; margin-right: 10px'></i></a>";
													echo "<a href='eliminar_estados.php?ID_Est=". $row['ID_Est'] ."' title='Eliminar' data-toggle='tooltip'><i class='fas fa-trash-alt' style='margin-left: 10px; margin-right: 10px'></i></a>";
												echo "</td>";
											echo "</tr>";
										}
										echo "</tbody>";                            
