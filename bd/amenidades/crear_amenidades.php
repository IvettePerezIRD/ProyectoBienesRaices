...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($ame_err)){
        $sql = "INSERT INTO amenidad (Nom_Ame) VALUES (?)";
		
        if($stmt = mysqli_prepare($mysqli, $sql)){
            mysqli_stmt_bind_param($stmt, "s", $param_ame);
					...
					<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
						...
						<div class="form-row">
							...
							<div class="form-group col-md-3 <?php echo (!empty($ame_err)) ? 'has-error' : ''; ?>">
								<input type="text" name="amenidad" class="form-control" placeholder="Baños" required>
							</div>
							<div class="form-group col-md-3">
