			...
			<div class="wrapper2">
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-12">
							<div class="col-md-8">
								<h2 class="pull-left"><b>Amenidades</b></h2>
							</div>
							<div class="col-md-4">
								<br>
								<a href="crear_amenidades.php" class="btn btn-success pull-right">Agregar nueva amenidad</a>
							</div>
							<?php
							// Include config file
								...
								if(mysqli_num_rows($result) > 0){
									echo "<table class='table table-bordered table-striped'>";
										echo "<thead>";
											echo "<tr>";
												echo "<th>#</th>";
												echo "<th>Nombre de la amenidad</th>";
												echo "<th>Acción</th>";
											echo "</tr>";
										echo "</thead>";
										echo "<tbody>";
										while($row = mysqli_fetch_array($result)){
											echo "<tr>";
												echo "<td>" . $row['ID_Ame'] . "</td>";
												echo "<td>" . $row['Nom_Ame'] . "</td>";
												echo "<td width='8%'>";
													echo "<a href='cambiar_amenidades.php?ID_Ame=". $row['ID_Ame'] ."' title='Actualizar' data-toggle='tooltip'><i class='fas fa-pencil-alt' style='margin-left: 10px; margin-right: 10px'></i></a>";
													echo "<a href='eliminar_amenidades.php?ID_Ame=". $row['ID_Ame'] ."' title='Eliminar' data-toggle='tooltip'><i class='fas fa-trash-alt' style='margin-left: 10px; margin-right: 10px'></i></a>";
												echo "</td>";
											echo "</tr>";
										}
										echo "</tbody>";                            
