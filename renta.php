...
<!-- InstanceBeginEditable name="ContenidoEditable" -->
	...
	$sql = "SELECT inmueble.ID_Inm, inmueble.Nom_Inm, inmueble.Precio_Inm, tipo.Nom_Tipo, inmueble.Galeria_Inm, inmueble.Descripcion_Inm FROM inmueble inner join tipo on inmueble.ID_Tipo_Inm = tipo.ID_Tipo WHERE Catego_Inm = 'Renta' AND Estatus_Inm = 'Aceptado';";
